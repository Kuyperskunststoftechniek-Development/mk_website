...
<template>
  ...
  >
    <div class="hidden" aria-hidden="true">
      <label>
        Website
        <input v-model="state.website" type="text" tabindex="-1" autocomplete="off">
      </label>
    </div>
    ...
    <div class="grid gap-5 md:grid-cols-2">
      ...
      <div class="md:col-span-2 flex flex-wrap items-center gap-4">
        ...
        <p v-if="status === 'error'" class="text-sm text-[color:var(--err)]">
          {{ errorMsg }}
        </p>
      </div>
    </div>
